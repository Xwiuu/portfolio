...
const projects: Project[] = [
  { id: "01", title: "NEON NEXUS", category: "Web Arch", img: "https://images.unsplash.com/photo-1481487484168-9b995ecc1679?q=80&w=2000", color: "#10b981" },
  { id: "02", title: "VOID WALKER", category: "3D Exp", img: "https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?q=80&w=2000", color: "#8b5cf6" },
  { id: "03", title: "CYBER CORE", category: "Security", img: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2000", color: "#ef4444" },
  { id: "04", title: "AERO GRID", category: "SaaS", img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2000", color: "#3b82f6" },
  { id: "05", title: "DATA HIVE", category: "Big Data", img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=2000", color: "#f59e0b" },
  { id: "06", title: "QUANTUM", category: "Fintech", img: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=2000", color: "#ec4899" },
  { id: "07", title: "BIO SYNTH", category: "Health", img: "https://images.unsplash.com/photo-1576086213369-97a306d36557?q=80&w=2000", color: "#06b6d4" },
  { id: "08", title: "ECHO", category: "Social", img: "https://images.unsplash.com/photo-1478737270239-2f02b77ac6d5?q=80&w=2000", color: "#ffffff" }
];
      ...
      >
        ...
        <div className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none">
           ...
           >
              ...
              <div className="absolute inset-0 border border-emerald-500/30 rounded-full animate-spin-slow" style={{ animationDuration: '10s' }}></div>
           </div>
        </div>
        ...
        {projects.map((project, index) => {
          ...
          return (
            <div 
              ...
              className="project-card relative w-screen md:w-[600px] shrink-0 flex flex-col justify-center items-center h-full mx-4 md:mx-20"
            >
              <div className={`relative w-[80vw] md:w-[500px] flex flex-col ${isTop ? 'mb-40' : 'mt-40'}`}>
                ...
                ></div>
                <div className={`absolute left-1/2 w-2 h-2 rounded-full z-0 ${isTop ? 'bottom-20' : 'top-20'}`} style={{ background: project.color }}></div>
                ...
                <div className="group relative bg-[#0a0a0a] border border-white/10 rounded-2xl p-2 overflow-hidden hover:border-white/30 transition-colors duration-500 shadow-2xl">
                    ...
                    <div className="relative h-75 md:h-100 w-full rounded-xl overflow-hidden bg-gray-900">
                      ...
                      <div className="absolute top-4 left-4 z-20 bg-black/50 backdrop-blur border border-white/10 px-3 py-1 rounded-full">
                          <span className="text-[10px] font-mono uppercase tracking-widest text-white">{project.category}</span>
                      </div>
                    </div>
